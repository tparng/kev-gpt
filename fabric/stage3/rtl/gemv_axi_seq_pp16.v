// -----------------------------------------------------------------------------
// gemv_axi_seq_pp16 — AXI4-Lite shell around sequencer_pp at N=16 (8 LUT + 8
// DSP-packed GEMM streams). IDCODE "SQ16" (0x53513136). The SQPP map is kept
// verbatim; streams 8..15 are additive:
        ...
        if (!aresetn) begin
            ...
            if (S_AXI_ARREADY) begin
                ...
                case (araddr_idx)
                    ...
                    6'h0B: S_AXI_RDATA <= 32'h5351_3136;          // "SQ16"
