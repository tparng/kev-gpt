...
#   vivado -mode batch -source ooc_mamba_pipe.tcl -tclargs <PERIOD_NS> <NC>
...
synth_design -top mamba_pipe -part $part -mode out_of_context \
    -generic NC=$nc -generic TMAX=2 -generic T_TOKENS=2
...
puts "MAMBA_PIPE_SYNTH nc=$nc uram=$s_uram ramb36=$s_ramb36 ramb18=$s_ramb18 dsp=$s_dsp"
puts "KV260_AVAIL uram=64 ramb36=144 dsp=1248"
