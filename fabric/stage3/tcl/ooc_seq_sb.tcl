...
#   vivado -mode batch -source ooc_seq_sb.tcl -tclargs <P> <LANES> <PERIOD_NS> <WWORDS> <TMAX> <ND> <NC> <ATT2>
...
if {$nc     eq ""} { set nc 8 }
# ATT2 = 1 -> vec_attn per cohort (the §26 un-share); 0 -> shared+arbiter (fits today)
...
puts "===== OOC sequencer_sb P=$pp LANES=$lanes N=$nn NC=$nc ND=$nd ATT2=$att2 @ ${period}ns ====="
report_utilization
