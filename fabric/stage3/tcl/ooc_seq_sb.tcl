...
#   vivado -mode batch -source ooc_seq_sb.tcl -tclargs <P> <LANES> <PERIOD_NS> <WWORDS> <TMAX> <ND>
...
synth_design -top sequencer_sb -part $part -mode out_of_context \
    -generic P=$pp -generic LANES=$lanes -generic N=16 -generic NC=8 \
    -generic ND=$nd -generic NLAYER=4 \
    -generic WWORDS=$wwords -generic TMAX=$tmax

create_clock -name clk -period $period [get_ports clk]

puts "===== OOC sequencer_sb P=$pp LANES=$lanes ND=$nd @ ${period}ns ====="
report_utilization
