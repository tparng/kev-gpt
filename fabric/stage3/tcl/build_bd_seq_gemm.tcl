# Stage 3 10k — PS+PL block design for the P-WIDE datapath sequencer (gemv_axi_seq_gemm +
# sequencer_gemm + layernorm_vec + vec_dequant + vec_attn + vec_gelu + gelu_lut + softmax +
...
set bdir  "C:/kevbuild/stage3_seqgemm_bit"
set mems  "C:/kevbuild/stage3_seq_vec_p$pp"       ;# wide-word ROMs — P-DEPENDENT (packed P/word)

file mkdir $bdir
create_project gemv_seqgemm_pl "$bdir/gemv_seqgemm_pl" -part $part -force
set_property board_part $board [current_project]

add_files -norecurse [list \
    "$root/fabric/stage3/rtl/gemv_axi_seq_gemm.v" \
    "$root/fabric/stage3/rtl/sequencer_gemm.sv" \
...
set g [create_bd_cell -type module -reference gemv_axi_seq_gemm seq]
