...
def main(argv=None):
    ap = argparse.ArgumentParser(prog="fabric.stage3.run_ssm_scan_row")
    ap.add_argument("--steps", type=int, default=256)
    ap.add_argument("--seed", type=int, default=0)
    ap.add_argument("--dir", default=None)
    args = ap.parse_args(argv)

    sim = args.dir or kevbuild("stage3_ssm_row")
    ...
    # compile + run
    src = [f"{REPO}/fabric/stage3/rtl/ssm_scan_row.sv",
           f"{REPO}/fabric/stage3/tb/tb_ssm_scan_row.sv"]
    ...
    print(f"SSM_ROW_VERDICT: {'BIT-EXACT' if mism == 0 else 'FAIL'} "
